                  ...
                  <div className="layout-list-item">
                    {
                      <>
                        <div>
                          ...
                          />
                          <span>
                            {item.week_weather[(weekday + 6) % 7]?.temperature}
                            {"\u00B0C"}
                          </span>
                        </div>
                        <div>
                          <img
                            src={item.week_weather[weekday % 7]?.weather_image}
                            alt=""
                          />
                          <span>
                        ...
                        <div>
                          ...
                          />
                          <span>
                            {item.week_weather[(weekday + 1) % 7]?.temperature}
                            {"\u00B0C"}
                          </span>
                        </div>
                        <div className="layout-list-item--active">
                          ...
                          />
                          <span>
                            {item.week_weather[(weekday + 2) % 7]?.temperature}
                            {"\u00B0C"}
                          </span>
                        </div>
                      </>
